        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav  ">
            <li class="nav-item active"  id="home">
              <button class="nav-link" onclick="loadHome()">Trang chủ <span class="sr-only">(current)</span></button>
            </li>
            <li class="nav-item" id="listProduct">
              <button class="nav-link" onclick="listProduct()" >
                Sản phẩm
              </button>
            <li class="nav-item">
...
<!--            <li class="nav-item">-->
              ...
              <button class="nav-link" onclick="logout()" >Đăng xuất</a>
